...
public class DataChangeConsole : MonoBehaviour
{
    ...
    {
        DataManager.instance.STRING_UserProfile.SetValue(UserProfileData.UserName, value_str);
    }

    // valueName의 key값을가진 int 데이터를 value_int로 변환
    public void SetValue_int()
    {
        DataManager.instance.INT_Currency.SetValue(CurrencyData.GoldCoin, value_int);
    }
